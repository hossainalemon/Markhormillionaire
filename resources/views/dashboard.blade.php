										...
										<div class="card card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-muted mt-1 fw-bold fs-7">Total Pending: </span>
												</h3>
															...
															<tr>
																...
																<td>
																	<div class="d-flex justify-content-end flex-shrink-0">
																		...
																		<a href="{{ route('deposit.update', $deposit->id) }}?status=active" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
