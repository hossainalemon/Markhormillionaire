		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/development-hd.png)">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<!--begin::Wrapper-->
					<div style=" background: #100851 !important;" class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">

						<!--begin::Logo-->
					<a href="/" class="mb-12">
						<img alt="Logo" src="assets/media/logo_f.png" class="h-100px" style="margin: 0px 100px;" />
					</a>
					<!--end::Logo-->
					@if(session('success'))
